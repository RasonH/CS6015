...
public:
    ...
    */
    virtual void pretty_print_at(std::ostream &ostream, std::streampos &lastReturnSeen) = 0;
...
public:
    ...
    */
    ...
    void pretty_print_at(std::ostream &ostream, std::streampos &lastReturnSeen) override;
