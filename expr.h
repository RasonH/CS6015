...
public:
    ...
    * \param lastLvlLeft tracking where did the last binding came from, return true if it is the left hand side of the upper level expression
    * \param lastLvlMult tracking where did the last binding came from, return true if the upper level expression is a Mult
    */
...
public:
    ...
    */
    ...
    void pretty_print_at(std::ostream &ostream, std::streampos &lastReturnSeen, bool lastLvlLeft, bool lastLvlMult) override;
